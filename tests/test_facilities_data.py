...
def test_facilities_pandas_dataframe_output(sample_facilities_raw_response):
    ...
    print("   ✅ ERARING facility info duplicated correctly")
    ...
    print("   Each unit gets its own row with facility info duplicated")
